...
| **Admin**         | PUT    | `/api/v1/users/{id}/language` | [Authorize]             | Cập nhật ngôn ngữ ưu tiên                           |
...
_Service thu thập log kiểm toán tập trung từ các nguồn._
...
_Service theo dõi vòng đời giao dịch._
...
_Cập nhật lần cuối: 07/05/2026 - Nâng cấp hệ thống bảo mật Enterprise và Identity Service Production-Ready._
