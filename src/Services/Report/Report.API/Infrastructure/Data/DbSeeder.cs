        ...
        public static async Task SeedAsync(AppDbContext context, ILogger logger)
        {
            ...
            if (!await context.Invoices.AnyAsync())
            {
                context.Invoices.AddRange(
                    new Report.API.Domain.Entities.Invoice { Id = Guid.Parse("f1d2c3b4-a5e6-4d7f-8e9a-0b1c2d3e4f5a"), CustomerName = "", Amount = 1500, Status = InvoiceStatus.Pending, CreatedAt = DateTime.UtcNow.AddDays(-5) },
