...
Log.Logger = new LoggerConfiguration()
    ...
    .WriteTo.GrafanaLoki(lokiUrl,
        labels: new[]
        {
            new LokiLabel { Key = "service", Value = "admin-api" },
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "BizCore Admin API",
        Version = "v1",
        Description = "Enterprise Organization, Master Data & Identity Service"
    });
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "BizCore Admin API v1");
